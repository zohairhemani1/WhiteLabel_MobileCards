...
";
    ...
    <!-- BEGIN LOGIN FORM -->
    <form name="login" id="loginform" method="post" class="form-vertical no-padding no-margin" action="login.php?upgrade=<?php echo $upgrade;?>">
      <div class="lock">
          <i class="icon-lock"></i>
      </div>
...
<form name="register" id="registerform" method="post" class="form-vertical no-padding no-margin hide" action="login.php">
 ...
 <div class="input-prepend">
      ...
      <input type="Submit" id="btnSign" class="btn btn-block login-btn" value="Submit" />
    </form>
  </div>
  <!-- END LOGIN -->
  <!-- BEGIN COPYRIGHT -->
