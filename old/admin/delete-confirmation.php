				...
				<div data-role="page" data-theme="a" style = "margin-top:-20px; position:relative;">
						...
						<div data-role="content" style="width:70%; margin-left:14%;">
							<ul data-role="listview" data-inset="true" data-divider-theme="b" data-icon="delete"">
                                ...
                                <center><div><h1> ARE YOU SURE YOU WANT TO DELETE THE CARD ?</h1></div>
                                
                                
                                
                               <form action="#" method="post" target="_blank" >
                                  <a href="#" onclick="closeWindow()">  <input type = "submit" value = "NO" /> </a>
                                    <a href = "delete.php?user=<?php echo $username;  ?>" target = "_blank" onclick="closeWindow()"> <input type = "submit" value = "YES" /> </a>                             		
                               </form>
 </center>
							</ul>
