...
header("location: index.html");		
		...
		//echo $username . "Card Deleted.";
		$query_delete = "DELETE from registeration WHERE username like '$username'";
...
<body>
	...
	<!-- topbar ends -->
          	...
          	<center><h1> You have successfully deleted <?php echo $username; ?>'s Card </h1></center>
